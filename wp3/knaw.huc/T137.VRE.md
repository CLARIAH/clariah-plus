...
2. **Implementation** (2 to 4 months, **in progress**) - Implementation and testing of all proposed functionality.
    * Relevant software milestones (in no particular order):
        * [CLAM v3.1 - Authentication milestone](https://github.com/proycon/clam/milestone/12)
        * [CLAM v3.2](https://github.com/proycon/clam/milestone/11)
        * [FLAT v0.10 - Authentication milestone](https://github.com/proycon/flat/milestone/19)
        * [FLAT v1.0](https://github.com/proycon/clam/milestone/17)
        * [LaMachine - Authentication milestone (T098M2)](https://github.com/proycon/LaMachine/milestone/11)
...
* 1.2.2 - Updated usecases and planning, added federation authentication milestone (T098M2) (see git log for full
    diff)
* 1.2.3 - Split authentication milestones from the main milestones
